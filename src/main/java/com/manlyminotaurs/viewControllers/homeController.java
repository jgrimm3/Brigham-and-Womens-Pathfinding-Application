...
//        scrollGroup.setScaleX(scaleValue);
//        scrollGroup.setScaleY(scaleValue);
//    }
//
...
//
//        double zoomFactor = Math.exp(wheelDelta/33 * zoomIntensity);
//        Bounds innerBounds = scrollGroup.getLayoutBounds();
...
//        Point2D posInZoomTarget = scrollGroup.parentToLocal(mousePoint);
//
//        // calculate adjustment of scroll position (pixels)
//        Point2D adjustment = scrollPaneMap.getLocalToParentTransform().deltaTransform(posInZoomTarget.multiply(zoomFactor - 1));
//
//        // convert back to [0, 1] range
//        // (too large/small values are automatically corrected by ScrollPane)
//        Bounds updatedInnerBounds = scrollGroup.getBoundsInLocal();
//
////        scrollPaneMap.setHvalue(valX + (adjustment.getX() / updatedInnerBounds.getWidth()));
////                (valX + adjustment.getX()) / (updatedInnerBounds.getWidth() - viewportBounds.getWidth()));
////        scrollPaneMap.setVvalue(valY + (adjustment.getY() / updatedInnerBounds.getHeight()));
////                (valY + adjustment.getY()) / (updatedInnerBounds.getHeight() - viewportBounds.getHeight()));
//
//        System.out.println(scrollPaneMap.getHvalue() + " Out of " + scrollPaneMap.getHmax());
//        System.out.println(scrollPaneMap.getVvalue() + " Out of " + scrollPaneMap.getVmax());
//    }
    ...
    public void initialize() {
        ...
        //Set Up Stuff For Zoom
        scrollPaneMap.setPannable(true);
        scrollPaneMap.setHbarPolicy(ScrollPane.ScrollBarPolicy.NEVER);
        scrollPaneMap.setVbarPolicy(ScrollPane.ScrollBarPolicy.NEVER);
