...
public class ClosestStrategyITest {
    ...
    public void createFixtures(){
        ...
        node2_2 = new Room("N2X2Y",2,2,"F1","BUILD1","REST","Node 2, 2", "n2x2y",1,0,0);
    ...
    @Test
    public void Find_WhenClosestBathroom_ShouldReturnPath(){
        ...
        try {
            result = pf.find(node0_0, new Room("N2X2Y",2,2,"F1","BUILD1","REST","Node 2, 2", "n2x2y",1,0,0));
