...
public class AStarStrategyITest {
    ...
    public void createFixtures(){
        ...
        node2_1 = new Hallway("N2X1Y",2,1,"F1","BUILD1","HALL","Node 2, 1", "n2x1y",1,0,0);
        ...
        node1_3 = new Hallway("N1X3Y",1,3,"F1","BUILD1","HALL","Node 1, 3", "n1x3y",1,0,0);
    ...
    public void Find_WhenStartAndEndNodesAreOnSameEdge_ShouldReturnPath(){
        ...
        LinkedList<Node> result = new LinkedList<>();
        try {
            result = pf.find(node0_0, node1_0);
        } catch (PathNotFoundException e){
            e.printStackTrace();
        }
        assertEquals(expected, result);
    ...
    public void Find_WhenManyNodesWithBranching_ShouldReturnPath(){
        ...
        LinkedList<Node> result = new LinkedList<>();
        try {
            result = pf.find(node1_0, node0_3);
        } catch (PathNotFoundException e){
            e.printStackTrace();
        }
        assertEquals(expected, result);
...
//        fixture.add("Continue straight at Node 1, 0 F1");
//        fixture.add("Turn right at Node 2, 0 F1");
//        fixture.add("Turn right at Node 2, 1 F1");
//        fixture.add("Continue straight at Node 1, 1 F1");
//        fixture.add("Turn left at Node 0, 1 F1");
//        assertEquals(fixture, pu.angleToText(pf.find(node1_0, node0_2)));
//    }
